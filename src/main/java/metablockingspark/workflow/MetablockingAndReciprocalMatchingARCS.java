...
public class MetablockingAndReciprocalMatchingARCS {
    ...
    public static void main(String[] args) {
        ...
        JavaPairRDD<Integer,IntArrayList> matches = new ReciprocalMatchingFromMetaBlocking().getReciprocalCandidateMatches(topKValueCandidates, topKNeighborCandidates);
