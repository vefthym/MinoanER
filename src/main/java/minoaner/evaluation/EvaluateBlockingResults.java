...
import minoaner.metablocking.entityBased.neighbors.CNPNeighborsUnnormalized;
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            ...
            try {                                
                ...
                Logger.getLogger(EvaluateBlockingResults.class.getName()).log(Level.SEVERE, null, ex);
            }            
        } else {
...
//        Broadcast<Int2IntOpenHashMap> blockSizes_BV = jsc.broadcast(blockSizes);        
        ...
        CNPNeighborsUnnormalized cnp = new CNPNeighborsUnnormalized();        
        ...
        JavaPairRDD<Integer, Int2FloatLinkedOpenHashMap> topKValueCandidates = cnp.getTopKValueSims(blocksFromEI, K, numNegativeEntities, numPositiveEntities);        
