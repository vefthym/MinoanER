...
import minoaner.matching.ReciprocalMatching;
...
public class FullMetaBlockingWorkflow {
    ...
    public static void main(String[] args) {
        ...
        JavaPairRDD<Integer,Integer> aggregates = new LocalRankAggregation().getTopCandidatePerEntity(topKValueCandidates, topKNeighborCandidates, LISTS_WITH_COMMON_CANDIDATES);
